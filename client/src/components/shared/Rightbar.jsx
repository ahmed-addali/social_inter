...
const Rightbar = () => {
  ...
  return (
    <div className="hidden rightbar overflow-auto scroll-custom">
      {currentLocation !== "/communities" && (
        <div>
          <div className="flex items-end justify-between mb-4">
            ...
            {remainingCount > 0 && (
              <Link
                className="flex relative items-center text-sm font-medium text-purple-500 mr-4"
                to="/communities"
              >
                See all
            ...
            {visibleCommunities?.map((community) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-purple-600 border border-dashed border-purple-500
                        hover:bg-purple-600 
          ...
          recommendedUsers.map((user) => (
            ...
            >
              ...
              <button
                ...
                className="text-purple-500 border border-dashed border-purple-500 hover:bg-purple-500 rounded-md py-1 px-2 text-sm font-semibold group transition duration-300"
              >
