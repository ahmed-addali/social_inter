...
const SignIn = () => {
  ...
  const handleDemoSignIn = async () => {
    setLoading(true);
    setLoadingText("Signing in to demo account...");
    await dispatch(demoSignInAction(navigate));
    setLoading(false);
  };
      ...
      <div className="container mx-auto flex min-h-screen flex-col items-center justify-center px-6">
        <form className="w-full max-w-md">
          ...
          <div className="mt-6 flex items-center justify-center">
            <Link
              to={"/signin"}
              className="w-1/3 border-b-2 border-purple-800 pb-4 text-center font-medium text-gray-800 "
            >
              Sign In
            </Link>
            <Link
          ...
          <div className="mt-6">
            <button
              ...
              className={`w-full transform rounded-lg bg-purple-500 px-6 py-3 text-sm font-medium tracking-wide text-white transition-colors duration-300 hover:bg-purple-800 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-50 ${
          ...
          <div className="mt-4">
            <button
              ...
              type="button"
              className={`w-full transform rounded-lg border-2 border-purple-500 bg-white px-6 py-3 text-sm font-medium tracking-wide text-purple-500 transition-colors duration-300 hover:bg-purple-50 focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-50 ${
                loading ? "cursor-not-allowed opacity-50" : ""
              }`}
            >
              {loading ? (
        ...
        <span className="flex items-center justify-center py-4 text-sm text-gray-600 ">
          <a
            href="https://github.com/nz-m/SocialInter"
            target="_blank"
          ...
          <Link
            to="/admin"
            className="ml-8 flex items-center hover:text-purple-500"
          >
